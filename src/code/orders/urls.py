...
urlpatterns = [
    ...
    path('track/update/<str:order_id>/', views.update_order_status_view, name='update_order_status'),
    path('cancel/<str:order_id>/', views.cancel_order, name='cancel_order'),
    path('refund/<str:order_id>/', views.request_refund, name='request_refund'),
